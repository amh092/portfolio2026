...
- 2026-08-05 — Step 2/2R approved in full (entrance mechanism + lead-in, Option A alive layer + §15.5 amendments, `blocking="render"` flash fix) and committed. Next: Step 3 — scroll reveals (section heads + standalone blocks)
