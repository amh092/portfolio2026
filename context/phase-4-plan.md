...
**In progress.** Branch `feature/main-sections` created 2026-08-02; Step 1 approved and committed. Next: Step 2 (Hero). Merge to `main` only after the Step 10 audit is approved.
