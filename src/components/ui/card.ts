...
export const CARD_SURFACE_CLASSES =
  "relative overflow-hidden rounded-lg border border-border bg-surface p-[1.6rem] transition-[border-color,background-color] duration-400 ease-smooth hover:border-accent/40 hover:bg-surface-2";
